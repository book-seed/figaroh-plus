...
#else
  #define CASADI_PREFIX(ID) test_cg_ ## ID
#endif
...
CASADI_SYMBOL_EXPORT int grad_f(const casadi_real** arg, casadi_real** res, casadi_int* iw, casadi_real* w, int mem){
  return casadi_f1(arg, res, iw, w, mem);
}

CASADI_SYMBOL_EXPORT int grad_f_alloc_mem(void) {
  return 0;
}

CASADI_SYMBOL_EXPORT int grad_f_init_mem(int mem) {
  return 0;
}

CASADI_SYMBOL_EXPORT void grad_f_free_mem(int mem) {
}

CASADI_SYMBOL_EXPORT int grad_f_checkout(void) {
  return 0;
}

CASADI_SYMBOL_EXPORT void grad_f_release(int mem) {
}

CASADI_SYMBOL_EXPORT void grad_f_incref(void) {
}

CASADI_SYMBOL_EXPORT void grad_f_decref(void) {
}

CASADI_SYMBOL_EXPORT casadi_int grad_f_n_in(void) { return 2;}

CASADI_SYMBOL_EXPORT casadi_int grad_f_n_out(void) { return 1;}

CASADI_SYMBOL_EXPORT casadi_real grad_f_default_in(casadi_int i) {
  switch (i) {
    default: return 0;
  }
}

CASADI_SYMBOL_EXPORT const char* grad_f_name_in(casadi_int i) {
  switch (i) {
    case 0: return "i0";
    case 1: return "i1";
    default: return 0;
...
CASADI_SYMBOL_EXPORT const char* grad_f_name_out(casadi_int i) {
  switch (i) {
    case 0: return "o0";
    default: return 0;
  }
...
CASADI_SYMBOL_EXPORT const casadi_int* grad_f_sparsity_in(casadi_int i) {
  switch (i) {
    case 0: return casadi_s0;
    case 1: return casadi_s0;
    default: return 0;
...
CASADI_SYMBOL_EXPORT const casadi_int* grad_f_sparsity_out(casadi_int i) {
  switch (i) {
    case 0: return casadi_s0;
    default: return 0;
  }
...
CASADI_SYMBOL_EXPORT int grad_f_work(casadi_int *sz_arg, casadi_int* sz_res, casadi_int *sz_iw, casadi_int *sz_w) {
  if (sz_arg) *sz_arg = 2;
  if (sz_res) *sz_res = 1;
  if (sz_iw) *sz_iw = 0;
  if (sz_w) *sz_w = 0;
...
CASADI_SYMBOL_EXPORT int grad_f_work_bytes(casadi_int *sz_arg, casadi_int* sz_res, casadi_int *sz_iw, casadi_int *sz_w) {
  if (sz_arg) *sz_arg = 2*sizeof(const casadi_real*);
  if (sz_res) *sz_res = 1*sizeof(casadi_real*);
  if (sz_iw) *sz_iw = 0*sizeof(casadi_int);
  if (sz_w) *sz_w = 0*sizeof(casadi_real);
